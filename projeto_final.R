...
#Mudanca de "NA" para "14" (n�mero arbitr�rio)
#Foi alterado "NA" para "14" para que esse valor possa ser removido da vari�vel
...
#Remoção dos "NA" (Numero 14 dentro da vari�vel)
